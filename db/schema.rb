...
ActiveRecord::Schema.define(version: 2018_08_06_062732) do
  ...
  create_table "exercises_tags", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
  ...
  create_table "workouts_exercises", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
